    ...
    switch (language) {
      case "ru":
        return {
          title: "Объемный вес",
          description:
            "Некоторые предметы имеют небольшой вес, но отличаются большим объемом. Если объемный вес превышает физический, то тариф на доставку определяется в соответствии с объём��ым весом, который рассчитывается по следующей формуле:",
          formula:
      ...
      default:
        return {
          title: "Объемный вес",
          description:
            "Некоторые предметы имеют небольшой вес, но отличаются большим объемом. Если объемный вес превышает физический, то тариф на доставку определяется в соответствии с объё��ным весом, который рассчитывается по следующей формуле:",
          formula:
