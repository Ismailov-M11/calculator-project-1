    ...
    switch (language) {
      ...
      default:
        return {
          ...
          cost: "Стоимость: 1% (без учета НДС 12%)",
          description:
            "Допо��нительный платеж, уплачиваемый Зак��зчи�����м Исполнителю при оглашении стоимости почтового отправления. Расчет размера доп��лн��тельного платежа производится по формуле - дополнительный платеж от стоимости (суммы) = 1% x объявленная стоимость (сумма).",
        };
    }
  };
