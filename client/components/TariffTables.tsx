    ...
    switch (language) {
      ...
      default:
        return {
          ...
          formula:
            "Объемный вес (кг) = (длина (см) х ширина (см) х ��ысота (см)) / 6000",
        };
    }
  };
      ...
      case "ru":
        return {
          ...
          notes: [
            ...
            "Если при вызове курьера Отправитель откажется передавать Отправление к доставке, Заказчик должен оплатить за ложный вызов курьера 25 000 сум без НДС (28 000 с Н��С)",
          ],
