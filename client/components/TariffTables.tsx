      ...
      case "ru":
        return {
          ...
          notes: [
            ...
            "Если Получатель изменил адрес доставки и просит доставить по другому адресу, то перенаправление посылки ��о новому адресу, будет тарифицироваться как отдельная заявка на доставку;",
