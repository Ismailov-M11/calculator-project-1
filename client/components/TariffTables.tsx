      ...
      case "ru":
        return {
          ...
          notes: [
            ...
            "Если Получатель изменил адрес доставки и просит доставить по друг��му адресу, то перенаправление посылки по новому адресу, будет тарифицироваться как отдельная заявка на доставку;",
