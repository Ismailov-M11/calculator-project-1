    ...
    switch (language) {
      ...
      default:
        return {
          ...
          cost: "Стоимость: 1% (без учета НДС 12%)",
          description:
            "Допо��нительный платеж, уплачиваемый Заказчи�����м Исполнителю при оглашении стоимости почтового отправления. Расчет размера доп��лнительного платежа производится по формуле - дополнительный платеж от стоимости (суммы) = 1% x объявленная стоимость (сумма).",
        };
    }
  };
    ...
    switch (language) {
      case "ru":
        return {
          title: "ПРИМЕЧАНИЕ:",
          notes: [
            "Каждое Отпра��ление тарифицируется по отдельности. В стоимость включена одна попытка доставки Отправления;",
            ...
            "Если при вызове курьера Отправитель откажется передавать Отправление к доставке, Заказчик должен оплатить за ложный вызов курьера 25 000 сум без Н��С (28 000 с НДС)",
          ],
