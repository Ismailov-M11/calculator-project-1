  ...
  const getDeliveryRatesText = () => {
    switch (language) {
      case "ru":
        return {
          title:
            "Во всех действующих тарифах используется следующая логика подсчета стоимости достав��и за каждый кил��грамм:",
          rates: [
      ...
      case "ru":
        return {
          ...
          notes: [
            ...
            "Если получатель отсутствует по адресу доставки или не может принять Отправление по другим, не зависящим от курьера причинам, то каждый последующий приезд курь��ра тарифицируется как новая отдельная заявка на доставку;",
